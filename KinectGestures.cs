...
public class KinectGestures
{
    ...
    public virtual int[] GetNeededJointIndexes() //인덱스  설정
    {
    ...
    */
    ...
    public virtual void CheckForGesture(long userId, ref GestureData gestureData, float timestamp, ref Vector3[] jointsPos, ref bool[] jointsTracked)
    {
        ...
        switch (gestureData.gesture)
        {
            ...
            case Gestures.Mansae:       // �� �� ���� ��� �ڼ�. RHPU LHPU Ȱ����
                switch (gestureData.state)
                {
                    case 0:
                        if ((jointsTracked[rightElbowIndex] && jointsTracked[rightHandIndex] && jointsTracked[rightShoulderIndex] &&
                        ...
                        {
                            SetGestureJoint(ref gestureData, timestamp, shoulderCenterIndex, jointsPos[shoulderCenterIndex]); //������ ���� Ȥ�� ������ ��� ����Ʈ�ε��� ��� ��� �߽��� ����������. �̺κ��� ���ۿ� ��ġ�� ������ ����.
                        }
                        break;
                    ...
                    case 1:
                        ...
                        d = Vector3.Angle((jointsPos[leftShoulderIndex] - jointsPos[leftElbowIndex]), (jointsPos[leftHandIndex] - jointsPos[leftElbowIndex]));      //���� ���� ���Ⱒ, �Ȳ�ġ �������� ���� ���� ����.
